...
$results.text2 = PowerShell -Version $Version -NoProfile .\script.with.Write-Error.ps1
$results.code2 = $LASTEXITCODE

# Q: What if the same script is dot-sourced as if its code is placed here?
# A: It exits with code 0.
$results.text3 = PowerShell -Version $Version -NoProfile ". .\script.with.Write-Error.ps1"
